...
1. Check your login default region to verify that there is a Cloud Foundry organization and space with this command:
    ...
    Click on the organization name (it will be your email by default) and then click on the **Add a Space** button. Choose the region from the pulldown and enter a name like `dev` for the space and click on **Save**
